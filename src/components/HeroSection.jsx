const HeroSection = () => {
  return (
    <div className="hero-container text-gray-100 flex flex-col items-center p-1 font-semibold text-center">
      ...
      <div className="w-full flex flex-col justify-center items-center uppercase gap-2 md:flex-row">
        <button className="hero-btn text-gray-50 border hover:bg-gray-50 hover:text-neutral-900 hover:outline-0">
          Get Started
        </button>
        <button className="hero-btn bg-gray-200 text-neutral-900 hover:bg-gray-50">
          Watch trailer
        </button>
      </div>
    </div>
